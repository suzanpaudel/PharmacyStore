...
namespace PharmacyStore.Controllers
{
    public class ProductStocksController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProductStockID,ProductID,StockQuantity")] ProductStock productStock)
        {
            ...
            ViewData["ProductID"] = new SelectList(_context.Product, "ProductID", "ProductName", productStock.ProductID);
            return View(productStock);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProductStockID,ProductID,StockQuantity")] ProductStock productStock)
        {
        ...
        {
            return _context.ProductStock.Any(e => e.ProductStockID == id);
        }
    }
}
