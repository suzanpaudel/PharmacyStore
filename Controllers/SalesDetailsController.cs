...
namespace PharmacyStore.Controllers
{
    public class SalesDetailsController : Controller
    {
        ...
        public IActionResult Create()
        {
            ...
            ViewData["SalesID"] = new SelectList(_context.Sales, "SalesID", "SalesBillNo");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("SalesDetailID,ProductID,SalesID,Quantity,SellingPrice,Remarks")] SalesDetail salesDetail)
        {
            ...
            ViewData["ProductID"] = new SelectList(_context.Product, "ProductID", "ProductName", salesDetail.ProductID);
            ViewData["SalesID"] = new SelectList(_context.Sales, "SalesID", "SalesBillNo", salesDetail.SalesID);
            return View(salesDetail);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SalesDetailID,ProductID,SalesID,Quantity,SellingPrice,Remarks")] SalesDetail salesDetail)
        {
